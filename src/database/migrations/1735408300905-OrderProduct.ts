...
export class OrderProduct1735408300905 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "order_product" ADD CONSTRAINT 
      "FK_8cf8bd5f1882d36faa31bbc1b8c" FOREIGN KEY ("categoryId") 
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "order_product" DROP CONSTRAINT "FK_8cf8bd5f1882d36faa31bbc1b8c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "order_product" DROP COLUMN "categoryId"`,
    );
